...
namespace App\Models {
     ...
     * @property-read int|null $productSuppliers_count
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<ProductSupplier>|ProductSupplier whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ProductSupplier>|ProductSupplier whereProductId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ProductSupplier>|ProductSupplier whereSupplierId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ProductSupplier>|ProductSupplier whereSupplierProductCode($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ProductSupplier>|ProductSupplier whereCostPrice($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ProductSupplier>|ProductSupplier whereIsPreferred($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ProductSupplier>|ProductSupplier whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ProductSupplier>|ProductSupplier whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ProductSupplier>|ProductSupplier newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<ProductSupplier>|ProductSupplier newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<ProductSupplier>|ProductSupplier query()
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     * @method static mixed fromSub($query, $as)
     ...
     * @mixin \Illuminate\Database\Query\Builder
     */
    class ProductSupplier extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
     ...
     * @property \Illuminate\Support\Carbon|null $updated_at
     * @property \Illuminate\Support\Carbon|null $created_at
     * @property mixed $quantity_received
     * @property float $cost_price_at_order
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<PurchaseOrderItem>|PurchaseOrderItem whereQuantityOrdered($value)
     * @method static \Illuminate\Database\Eloquent\Builder<PurchaseOrderItem>|PurchaseOrderItem whereCostPriceAtOrder($value)
     * @method static \Illuminate\Database\Eloquent\Builder<PurchaseOrderItem>|PurchaseOrderItem whereQuantityReceived($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Sale>|Sale wherePaymentMethod($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<SaleItem>|SaleItem wherePriceAtSale($value)

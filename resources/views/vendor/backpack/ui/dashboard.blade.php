...
@php
    ...
    // $lowStockCount = App\Models\Product::whereColumn('stock_quantity', '<=', 'min_stock_level')->count();

    $lowStockProducts = App\Models\Product::whereColumn('stock_quantity', '<=', 'min_stock_level')->get();
